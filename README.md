A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Last Agent Who Handled a Voice Interaction by Phone Number
